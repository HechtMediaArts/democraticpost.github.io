                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'entry-item clearfix' ); ?>>
                    ...
                    <?php if ( has_post_thumbnail() ) { ?>
                        ...
                        <div class="entry-thumb">
                         ...
                         <?php echo democratic_post_video_thumbnails(); ?>                         
                            
                             <?php elseif ( has_post_format( 'gallery' ) ) : ?>
                             <?php echo democratic_post_gallery_thumbnails() ?>
                             
                             <?php else : ?>  
                                       
                            <?php echo democratic_post_thumbnails() ?>
...
?>
                        ...
                        <?php } ?>
                            ...
                            <h2 class="entry-title listing"><a href="<?php the_permalink(); ?>"><?php echo $titel; ?></a></h2>
			...
			<?php evolution_after_post();?>
				...
				<?php get_template_part( 'nothing-found', get_post_format() ); ?>
