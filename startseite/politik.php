...
<?php $latest_blog_posts3 = new WP_Query( array( 'posts_per_page' => 1,'offset' =>1, 'category__in' => array( 87, 88, 89, 90 ) ) );

if ( $latest_blog_posts3->have_posts() ) : while ( $latest_blog_posts3->have_posts() ) : $latest_blog_posts3->the_post(); ?>
...
<?php $latest_politik_posts = new WP_Query( array( 'posts_per_page' => 2, 'offset' =>2, 'category__in' => array( 87, 88, 89, 90 ) ) );

if ( $latest_politik_posts->have_posts() ) : while ( $latest_politik_posts->have_posts() ) : $latest_politik_posts->the_post(); ?>
