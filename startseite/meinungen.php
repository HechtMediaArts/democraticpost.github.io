...
<span>Politische Meinungen</span>
</div> 
<?php do_action( 'evolution_meinungen_menu' ); ?>   
</div>
<div class="zilla-three-fourth zilla-column-last">

<?php $meinungen = new WP_Query( array( 'posts_per_page' => 1,'category__in' => array( 268, 269, 270 ) ) );
...
<?php $meinungen1 = new WP_Query( array( 'posts_per_page' => 2, 'offset' =>1, 'category__in' => array( 268, 269, 270 ) ) );
