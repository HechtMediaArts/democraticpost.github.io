...
<span class="unterhaltung">Unterhaltung</span>
</div> 
<?php do_action( 'evolution_unterhaltung_menu' ); ?>   
</div>
<div class="zilla-three-fourth zilla-column-last">

<?php $unterhaltung = new WP_Query( array( 'posts_per_page' => 1,'category__in' => array( 99, 107, 337, 103, 102, 100, 101 ) ) );

if ( $unterhaltung->have_posts() ) : while ( $unterhaltung->have_posts() ) : $unterhaltung->the_post(); ?>
