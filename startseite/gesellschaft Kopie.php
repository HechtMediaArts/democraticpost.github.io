...
<span class="gesellschaft">Gesellschaft</span>
</div> 
<?php do_action( 'evolution_gesellschaft_menu' ); ?>   
</div>
<div class="zilla-three-fourth zilla-column-last">

<?php $gesellschaft = new WP_Query( array( 'posts_per_page' => 1, 'offset' =>1, 'category__in' => array( 29, 93, 97, 96, 95, 94, 92, 98 ) ) );

if ( $gesellschaft->have_posts() ) : while ( $gesellschaft->have_posts() ) : $gesellschaft->the_post(); ?>
...
<?php $gesellschaft1 = new WP_Query( array( 'posts_per_page' => 2, 'offset' =>2, 'category__in' => array( 29, 93, 97, 96, 95, 94, 92, 98 ) ) );

if ( $gesellschaft1->have_posts() ) : while ( $gesellschaft1->have_posts() ) : $gesellschaft1->the_post(); ?>
