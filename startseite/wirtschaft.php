...
<?php do_action( 'evolution_wirtschaft_menu' ); ?>    
</div>
<div class="zilla-three-fourth zilla-column-last">

<?php $wirtschaft = new WP_Query( array( 'posts_per_page' => 1,'category__in' => array( 91, 477, 615, 616 ) ) );

if ( $wirtschaft->have_posts() ) : while ( $wirtschaft->have_posts() ) : $wirtschaft->the_post(); ?> 
...
<?php $wirtschaft1 = new WP_Query( array( 'posts_per_page' => 2, 'offset' =>1, 'category__in' => array( 91, 477, 615, 616 ) ) );

if ( $wirtschaft1->have_posts() ) : while ( $wirtschaft1->have_posts() ) : $wirtschaft1->the_post(); ?>
