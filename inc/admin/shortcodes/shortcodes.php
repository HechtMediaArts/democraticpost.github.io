...
if (!function_exists('zilla_one_third_last')) {
	function zilla_one_third_last( $atts, $content = null ) {
	   return '<div class="zilla-one-third zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_two_third_last')) {
	function zilla_two_third_last( $atts, $content = null ) {
	   return '<div class="zilla-two-third zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_one_half_last')) {
	function zilla_one_half_last( $atts, $content = null ) {
	   return '<div class="zilla-one-half zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_one_fourth_last')) {
	function zilla_one_fourth_last( $atts, $content = null ) {
	   return '<div class="zilla-one-fourth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_three_fourth_last')) {
	function zilla_three_fourth_last( $atts, $content = null ) {
	   return '<div class="zilla-three-fourth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_one_fifth_last')) {
	function zilla_one_fifth_last( $atts, $content = null ) {
	   return '<div class="zilla-one-fifth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_two_fifth_last')) {
	function zilla_two_fifth_last( $atts, $content = null ) {
	   return '<div class="zilla-two-fifth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_three_fifth_last')) {
	function zilla_three_fifth_last( $atts, $content = null ) {
	   return '<div class="zilla-three-fifth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_four_fifth_last')) {
	function zilla_four_fifth_last( $atts, $content = null ) {
	   return '<div class="zilla-four-fifth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_one_sixth_last')) {
	function zilla_one_sixth_last( $atts, $content = null ) {
	   return '<div class="zilla-one-sixth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_five_sixth_last')) {
	function zilla_five_sixth_last( $atts, $content = null ) {
	   return '<div class="zilla-five-sixth zilla-column-last">' . do_shortcode($content) . '</div><div class="clearfix"></div>';
	}
...
if (!function_exists('zilla_tabs')) {
	function zilla_tabs( $atts, $content = null ) {
		...
		if( count($tab_titles) ){
		   $output .= '<div id="zilla-tabs-'. $i .'" class="clearfix zilla-tabs">';
			$output .= '<ul class="etabs">';
			
			foreach( $tab_titles as $tab ){
				$output .= '<li class="tab"><a href="#zilla-tab-'. sanitize_title( $tab[0] ) .'">' . $tab[0] . '</a></li>';
			}
...
if (!function_exists('zilla_tab')) {
	function zilla_tab( $atts, $content = null ) {
		...
		return '<div id="zilla-tab-'. sanitize_title( $title ) .'">'. do_shortcode( $content ) .'</div>';
	}
