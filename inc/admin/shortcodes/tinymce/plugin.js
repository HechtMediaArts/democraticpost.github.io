	...
	tinymce.create("tinymce.plugins.zillaShortcodes",
	{
		init: function ( ed, url )
		{
			ed.addCommand("zillaPopup", function ( a, params )
			{
				...
				// load thickbox
				tb_show("Insert Evolution Shortcode", url + "/popup.php?popup=" + popup + "&width=" + 800);
			});
		},
		createControl: function ( btn, e )
		{
			...
			{	
				...
				var btn = e.createSplitButton('zilla_button', {
                    title: "Insert Evolution Shortcode",
					image: ZillaShortcodes.plugin_folder +"/tinymce/images/favicon.ico",
					icons: false
                });
