...
class ZillaShortcodes {
    ...
    {	
    	...
    	define('ZILLA_TINYMCE_URI', get_bloginfo('template_directory') .'/inc/admin/shortcodes/tinymce');
		define('ZILLA_TINYMCE_DIR', get_bloginfo('template_directory') .'/inc/admin/shortcodes/tinymce');

/**
 * Shortcode-Generator aktivieren oder deaktivieren
 * 
 * @return true or false
 */
		if ( of_get_option( 'shortcode_deactivation' ) == 'aktiviert' ) {
	...
	function init()
	{
		if( ! is_admin() )
		{
			...
			wp_enqueue_script( 'evo-shortcodes-lib', get_bloginfo('template_directory') . '/inc/admin/shortcodes/js/evo-shortcodes-lib.js', '', '', true);
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'ZillaShortcodes', array('plugin_folder' => get_bloginfo('template_directory') .'/inc/admin/shortcodes') );
