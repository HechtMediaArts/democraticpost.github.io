...
// Registers our widget
 register_widget( 'Evolution_About_Widget' );


class Evolution_About_Widget extends WP_Widget {
 ...
 */
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Zeigt einen kleinen "Über mich" Block mit dem Autoren-Gravatar an.', 'evolution' ),
		);
		...
		$this->WP_Widget( 'user-profile', __( 'Evolution Über mich', 'evolution' ), $widget_ops, $control_ops );
