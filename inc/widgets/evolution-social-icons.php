...
class Simple_Social_Icons_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->profiles = array(
			...
			'website' => array(
				'label'		  => __( 'Website URI', 'ssiw' ),
				'pattern'	  => '<li class="social-website"><a href="%s" %s>&#x77;</a></li>',
			),
			'facebook' => array(
		...
		$widget_ops = array(
			...
			'description' => __( 'Zeigt Icons von ausgewählten Social Networks an.', 'ssiw' ),
		);
		...
		$this->WP_Widget( 'simple-social-icons', __( 'Evolution Simple Social Icons', 'ssiw' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'border_radius' ); ?>"><?php _e( 'Icon Border Radius:', 'ssiw' ); ?></label> <input id="<?php echo $this->get_field_id( 'border_radius' ); ?>" name="<?php echo $this->get_field_name( 'border_radius' ); ?>" type="text" value="<?php echo esc_attr( $instance['border_radius'] ); ?>" size="3" />%</p>
	...
	function widget( $args, $instance ) {
		...
		$before_widget = '<div class="widget header fix simple-social-icons">';
		$after_widget = '</div>';
	...
	function css() {
		...
		.simple-social-icons ul li a:hover {
			...
			-moz-border-radius: ' . $instance['border_radius'] . '%;
			-webkit-border-radius: ' . $instance['border_radius'] . '%;
